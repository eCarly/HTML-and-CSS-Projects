//These functions are for open/close the contact form
function openForm() {
...
function showSlides(n) {
    ...
    var dots = document.getElementsByClassName("dot"); //this takes all the class elements with the name "dot" and stores them in the varriable array "dots"
